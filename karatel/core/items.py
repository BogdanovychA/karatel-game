...
# База предметів -- зброя з модифікатором від витривалості
DEXTERITY_WEAPONS = (
    Weapon(
        "Різак для коробок",
...
# База предметів -- зброя з модифікатором від інтелекту
...
# База предметів -- зброя з модифікатором від харизми
CHARISMA_WEAPONS = (
    Weapon(
